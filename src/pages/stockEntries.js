...
const StockEntries = () => {
  ...
  return (
    <Flex h="100vh" flexDirection="column">
      ...
      <Flex bg="#01576B">
        <Flex w="100%" my="10" maxW={1120} mx="auto" px="6" h="100vh">
        <Sidebar />
        ...
        <Box w="100%">
          <SimpleGrid minChildWidth={240} h="fit-content" spacing="6">
            ...
            />
            <Button w="40" color="#01576b" onClick={handleNewEntry}>
              SALVAR
            </Button>
          </SimpleGrid>
          ...
          <Box overflowY="auto" height="80vh">
            <Table mt="6">
              <Thead>
                <Tr>
                  <Th fontWeight="bold" fontSize="14px" color="#fff">
                    Nome
                  </Th>
                  <Th fontWeight="bold" fontSize="14px" color="#fff">
                    Qtd.
              ...
              <Tbody>
                {listStockEntries.map((item, i) => (
                  <Tr key={i}>
                    <Td color="#fff">{getProductById(item.product_id)}</Td>
